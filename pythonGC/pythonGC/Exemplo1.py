...
class Cubos(BasicOpenGL):
    def __init__(self,full_screen=False):
        ...
        self.cores = ((1, 0, 0), (1, 1, 0), (0, 1, 0), (0, 1, 1),  # Colors of the cube
    ...
    def update(self):
        ...
        mousePos = [
            x.value - self.window_width/2,
            y.value - self.window_height/2
        ]
        ...
        logging.debug(f"Camera position: {self.camera}", )
        logging.debug(f"Mouse position: {mousePos}", )
